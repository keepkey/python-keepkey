...
_ETHEREUMSIGNTX = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='address_type', full_name='EthereumSignTx.address_type', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='exchange_type', full_name='EthereumSignTx.exchange_type', index=9,
