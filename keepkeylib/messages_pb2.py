...
_MESSAGETYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MessageType_CharacterRequest', index=57, number=80,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), '\230\265\030\001'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MessageType_CharacterAck', index=58, number=81,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), '\220\265\030\001'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MessageType_RawTxAck', index=59, number=82,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), '\220\265\030\001'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MessageType_ApplyPolicies', index=60, number=83,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), '\220\265\030\001'),
      type=None),
    _descriptor.EnumValueDescriptor(
...
_MESSAGETYPE.values_by_name["MessageType_GetECDHSessionKey"]._options = _descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), '\220\265\030\001')
_MESSAGETYPE.values_by_name["MessageType_ECDHSessionKey"].has_options = True
_MESSAGETYPE.values_by_name["MessageType_ECDHSessionKey"]._options = _descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), '\230\265\030\001')
_MESSAGETYPE.values_by_name["MessageType_SetU2FCounter"].has_options = True
_MESSAGETYPE.values_by_name["MessageType_SetU2FCounter"]._options = _descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), '\220\265\030\001')
