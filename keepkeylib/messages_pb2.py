...
_MESSAGETYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MessageType_OsmosisMsgIBCTranfer', index=140, number=1114,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\220\265\030\001')),
      type=None),
    _descriptor.EnumValueDescriptor(
...
_MESSAGETYPE.values_by_name["MessageType_OsmosisMsgIBCTranfer"].has_options = True
_MESSAGETYPE.values_by_name["MessageType_OsmosisMsgIBCTranfer"]._options = _descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\220\265\030\001'))
