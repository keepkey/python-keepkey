...
_SOLANASIGNTX = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='schema_payload', full_name='SolanaSignTx.schema_payload', index=4,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='schema_signature', full_name='SolanaSignTx.schema_signature', index=5,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='schema_signer_key_id', full_name='SolanaSignTx.schema_signer_key_id', index=6,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='token_recipient_owner', full_name='SolanaSignTx.token_recipient_owner', index=7,
