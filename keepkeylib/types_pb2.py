...
_COINTYPE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='address_type_p2tr', full_name='CoinType.address_type_p2tr', index=20,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='taproot', full_name='CoinType.taproot', index=21,
