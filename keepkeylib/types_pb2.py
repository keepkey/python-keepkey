...
_BUTTONREQUESTTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ButtonRequest_RemoveWipeCode', index=35, number=36,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ButtonRequest_ChangeWipeCode', index=36, number=37,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ButtonRequest_CreateWipeCode', index=37, number=38,
      options=None,
      type=None),
  ],
  containing_type=None,
