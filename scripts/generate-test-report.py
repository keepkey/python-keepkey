...
SECTIONS = [
    ...
    ('EX', 'ERC-7730 Runtime - What 7.15 Shows For A Certified Definition', '7.15.0',
     ...
     ['WHAT THE DEVICE EXECUTES (one capability table, shared by the preload verifier, the',
      ...
      '  addressName, embedded calldata. Containers @.from/@.to/@.value; signed constants.',
     ...
     [
         ...
         ('EX8', 'test_msg_ethereum_erc7730_runtime',
          ...
          "Native-currency aliases name only the chain's asset",
          "An address in the signer's alias set is shown as the chain's native asset; any other address stays an unknown token. The firmware token table wins over an alias.",
          ['Native asset amount']),
         ...
         ('EX12', 'test_msg_ethereum_erc7730_runtime',
          ...
          'Each value is formatted on device and always shown with its raw integer; a unit\'s base is marked "unit set by signer".',
         ...
         ('EX23', 'test_msg_ethereum_erc7730_runtime',
          ...
          'Numeric constants are values',
          'A signed numeric constant is formatted like a decoded value of the same type.',
          ['Constant formatted as an amount']),
         ...
         ('EX27', 'test_msg_ethereum_erc7730_runtime',
          ...
          'An inner definition the device cannot execute, or signed by an unknown key, is dropped and the call is shown blind; the outer review then continues.',
