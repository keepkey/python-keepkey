...
class TestMsgCosmosGetaddress(common.KeepKeyTest):
    ...
    def test_cosmos_getaddress(self):
        ...
        # self.assertEqual(binascii.hexlify(self.client.cosmos_get_address([-9, 0])), 'f68804ac9eca9483ab4241d3e4751590d2c05102')
        # self.assertEqual(binascii.hexlify(self.client.cosmos_get_address([0, 9999999])), '7a6366ecfcaf0d5dcc1539c171696c6cdd1eb8ed')
