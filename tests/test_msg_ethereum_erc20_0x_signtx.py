...
class TestMsgEthereum0xtxERC20(common.KeepKeyTest):
    ...
    # def test_sign_0x_approve_liquidity_ETH(self):
    ...
    #             '00000000000000000000000000000000000000000052b7d2dcc80cd2e4000000')   # approve amount
    #     )        
    #     self.assertEqual(sig_v, 37)
    #     self.assertEqual(binascii.hexlify(sig_r), 'f4e16960fff3ccf1ac60ed7f06d543a9218f9eebb2d9917c1d978b14d0798992')
    #     self.assertEqual(binascii.hexlify(sig_s), '7f106bf841f92761455c7027206794e132334a08170d679f060244af19cc53d4')

    def test_sign_0x_add_liquidity_ETH(self):
        self.setup_mnemonic_nopin_nopassphrase()
