...
class TestMsgGetaddressSegwitNative(common.KeepKeyTest):
    ...
    def test_show_multisig_3(self):
        ...
        for i in [1, 2, 3]:
            self.assertEqual(self.client.get_address("Testnet", parse_path("999'/1'/%d'/2/1" % i), False, multisig2, script_type=proto.SPENDWITNESS), 'tb1qch62pf820spe9mlq49ns5uexfnl6jzcezp7d328fw58lj0rhlhasge9hzy')
            self.assertEqual(self.client.get_address("Testnet", parse_path("999'/1'/%d'/2/0" % i), False, multisig1, script_type=proto.SPENDWITNESS), 'tb1qr6xa5v60zyt3ry9nmfew2fk5g9y3gerkjeu6xxdz7qga5kknz2ssld9z2z')
