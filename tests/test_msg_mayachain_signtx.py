...
class TestMsgMayaChainSignTx(common.KeepKeyTest):
    ...
    def test_mayachain_sign_tx(self):
        ...
        signature = self.client.mayachain_sign_tx(
            ...
            gas=100000000,
            msgs=[make_send(
                "smaya1ls33ayg26kmltw7jjy55p32ghjna09zp2mf0av",
                "smaya1jvt443rvhq5h8yrna55yjysvhtju0el705qyh0",
                10000
            )],
            memo="foobar",
            sequence=3,
    ...
    def test_sign_btc_add_liquidity(self):
        ...
        out1 = proto_types.TxOutputType(op_return_data=b'ADD:BTC.BTC:mayapub1addwnpepq2ynqt500fag3wyxsjuv7570qxr8rqtpx93hw3cpqaqxtwxesy76udcaxjj:420',
                              amount=0,
                              script_type=proto_types.PAYTOOPRETURN,
                              )
