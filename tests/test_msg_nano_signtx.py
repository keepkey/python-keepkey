...
class TestMsgNanoSignTx(common.KeepKeyTest):
    ...
    # These tests were removed because they broke in the trezor crypto update and
    # the provenance of the tests are unavailable. Other nano tests continue to pass (emulator)
