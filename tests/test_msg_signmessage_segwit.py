...
class TestMsgSignmessageSegwit(KeepKeyTest):
    ...
    def test_sign_testnet(self):
        ...
        self.assertEquals(sig.address, '2N4VkePSzKH2sv5YBikLHGvzUYvfPxV6zS9')
        self.assertEquals(hexlify(sig.signature), b'249e23edf0e4e47ff1dec27f32cd78c50e74ef018ee8a6adf35ae17c7a9b0dd96f48b493fd7dbab03efb6f439c6383c9523b3bbc5f1a7d158a6af90ab154e9be80')
    ...
    def test_sign_utf(self):
        ...
        self.assertEquals(sig_nfkd.address, '3CwYaeWxhpXXiHue3ciQez1DLaTEAXcKa1')
        ...
        self.assertEquals(sig_nfc.address, '3CwYaeWxhpXXiHue3ciQez1DLaTEAXcKa1')
