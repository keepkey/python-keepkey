...
class TestMsgSignmessageSegwitNative(KeepKeyTest):
    ...
    def test_sign(self):
        ...
        self.assertEquals(sig.address, 'bc1qyjjkmdpu7metqt5r36jf872a34syws33s82q2j')
    ...
    def test_sign_testnet(self):
        ...
        self.assertEquals(sig.address, 'tb1qyjjkmdpu7metqt5r36jf872a34syws336p3n3p')
        self.assertEquals(hexlify(sig.signature), b'289e23edf0e4e47ff1dec27f32cd78c50e74ef018ee8a6adf35ae17c7a9b0dd96f48b493fd7dbab03efb6f439c6383c9523b3bbc5f1a7d158a6af90ab154e9be80')
    ...
    def test_sign_long(self):
        ...
        self.assertEquals(sig.address, 'bc1qyjjkmdpu7metqt5r36jf872a34syws33s82q2j')
        self.assertEquals(hexlify(sig.signature), b'285ff795c29aef7538f8b3bdb2e8add0d0722ad630a140b6aefd504a5a895cbd867cbb00981afc50edd0398211e8d7c304bb8efa461181bc0afa67ea4a720a89ed')
    ...
    def test_sign_grs(self):
        ...
        self.assertEqual(base64.b64encode(sig.signature), 'KIJT20tKHV2sBZKWOFMQo1PvgJksR3ekQTOjNdEtNETabCh9Mq7EBx7EmuMn4gj4m6ChFaEp8QYiHI3VWQ/T3xM=')
    ...
    def test_sign_utf(self):
        ...
        self.assertEquals(sig_nfkd.address, 'bc1qyjjkmdpu7metqt5r36jf872a34syws33s82q2j')
        self.assertEquals(hexlify(sig_nfkd.signature), b'28d0ec02ed8da8df23e7fe9e680e7867cc290312fe1c970749d8306ddad1a1eda41c6a771b13d495dd225b13b0a9d0f915a984ee3d0703f92287bf8009fbb9f7d6')

        sig_nfc = self.client.sign_message('Bitcoin', [0], words_nfc, script_type=proto_types.SPENDWITNESS)
        self.assertEquals(sig_nfc.address, 'bc1qyjjkmdpu7metqt5r36jf872a34syws33s82q2j')
        self.assertEquals(hexlify(sig_nfc.signature), b'28d0ec02ed8da8df23e7fe9e680e7867cc290312fe1c970749d8306ddad1a1eda41c6a771b13d495dd225b13b0a9d0f915a984ee3d0703f92287bf8009fbb9f7d6')
