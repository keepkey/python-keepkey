...
_DEBUGLINKSTATE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='config_stor_count', full_name='DebugLinkState.config_stor_count', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='config_stor', full_name='DebugLinkState.config_stor', index=11,
